...
contextBridge.exposeInMainWorld('api', {
  ...
  aerialLandmarks: (data: any) => ipcRenderer.invoke('aerial:landmarks', data),
  aerialMapOverlay: (data: any) => ipcRenderer.invoke('aerial:mapOverlay', data),
  searchPlace: (data: any) => ipcRenderer.invoke('aerial:searchPlace', data),
