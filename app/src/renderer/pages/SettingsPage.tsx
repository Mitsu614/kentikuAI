      ...
      <div className="card" style={{ border: '2px solid #e67e22' }}>
        ...
        <div className="form-row">
          <div className="form-group">
            <label>業種</label>
            <select value={config.industryType || 'general'} onChange={e => setConfig({ ...config, industryType: e.target.value, industryConfirmed: true })} style={{ fontSize: 15, padding: '8px 12px' }}>
